...
\section{Experience}
  ...
  \cventry{03/2014--11/2016}{Software developer}{Sirius Research Group}{Risaralda - Colombia}{}{
    ...
    Used \textbf{nodejs and ZeroMQ} for the backend and \textbf{openlayers3} and \textbf{Javascript} for the frontend.
  }
...
\begin{itemize}
  ...
  \item GPLib, Gaussian Processes library, using C++ and \textbf{Armadillo}. % \urlfootnote{https://github.com/pin3da/gplib}
