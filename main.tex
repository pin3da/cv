...
\subsection{Vocational}
  \cventry{2017--Present}{Software developer}{DomainsBot Inc}{Remote Work}{}{Developer of internal services in Python and Amazon Web Services}
  \cventry{2014--2016}{Web developer}{Sirius Research Group}{Risaralda - Colombia}{}{ Map based platform that provides and consumes several geolocation services for Risaralda, Colombia. Using \textbf{nodejs and ZeroMQ} for backend and \textbf{openlayers3 and javascript} for frontend.}
  \cventry{2013--2014}{Web developer}{Universidad Tecnológica de Pereira}{Risaralda - Colombia}{}{ACM-ICPC-based online judge for local training at Universidad Tecnológica de Pereira.}
...
\cvitem{Competitive Programming}{Six years (2011 - present) training in algorithms and math for ACM-ICPC competitions.}
