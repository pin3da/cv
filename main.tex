...
\section{Education}
\cventry{2010-Present}{BSc in Computer Science}{Universidad Tecnológia de Pereira}{Risaralda - Colombia}{\textit{GPA: 4.5 / 5}}{expected graduation date: July 2016}  % arguments 3 to 6 can be left empty
...
\begin{itemize}
  ...
  \item Developer of UTPJudge, ACM-ICPC-based judge for programming assignments and local training at Universidad Tecnológica de Pereira. \urlfootnote{https://github.com/in-silico/utpjudge}
...
\begin{cvcolumns}
  \cvcolumn{Contacts}{
    \begin{itemize}
       ...
       \item Sebastián Gómez González, MSc. Professor of Universidad Tecnológica de Pereira. Email: sebasutp@gmail.com
