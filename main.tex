...
\homepage{https://github.com/pin3da/}                               % optional, remove / comment the line if not wanted
...
\section{Work Experience}
  \cventry{01/2017--12/2017}{Software developer}{DomainsBot Inc}{Remote Work}{}{
    - Developed a distributed system to improve the accuracy of the domain names availability using \textbf{Python and AWS.} \\
    - Developed an ETL service that daily downloads more than 1200 files from heterogeneous sources and saves them in a single format using \textbf{Airflow} and AWS. \\
  ...
  \cventry{01/2013--12/2014}{Web developer}{Universidad Tecnológica de Pereira}{Risaralda - Colombia}{}{
    -Built an ACM-ICPC-based online judge for local training at my University.
  }

  \section{Personal Projects}

  \begin{itemize}
    \item Co-organizer of PereiraJS and PereiraTechTalks, local communities about programming in Pereira, Risaralda. % \urlfootnote{http://pereirajs.org, https://blog.pereiratechtalks.com/}
