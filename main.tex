...
\section{Experience}
  \cventry{2017}{Software developer}{DomainsBot Inc}{Remote Work}{}{
    - Developer of a distributed system to discover DNS avaiavility using \textbf{Python and AWS.} \\
    ...
    Used tecnologies among the projects: \textbf{graphite/statsd} for monitoring, \textbf{logentries} for log analytics, and \textbf{ansible} for deploys.
  }
  \cventry{2014--2016}{Software developer}{Sirius Research Group}{Risaralda - Colombia}{}{
    - Developer of a map based platform that provides and consumes several geolocation services for Risaralda, Colombia.
    Involved in the project since the desing of the architecture.\\
    Used \textbf{nodejs and ZeroMQ} for the backend and \textbf{openlayers3 and javascript} for the frontend.
  }
  \cventry{2013--2014}{Web developer}{Universidad Tecnológica de Pereira}{Risaralda - Colombia}{}{
...
\cventry{2010-2016}{BSc in Computer Science}{Universidad Tecnológia de Pereira}{Risaralda - Colombia}{\textit{distinguished student with GPA: 4.3 / 5}}{March 2016}  % arguments 3 to 6 can be left empty
...
\cvlistitem{Second place. ACM ICPC South America-North Regional Contest. Bogotá, Colombia. 2017 \footnotemark[1]}
% \cvlistitem{Third place. XXXI Maraton Nacional de Programacion ACIS REDIS, Colombia. 2017}
\cvlistitem{Best ranked colombian at the \textbf{Distributed Google Code Jam 2017}. \footnotemark[3]}
\cvlistitem{Best ranked colombian at the \textbf{Google Code Jam 2016}. \footnotemark[2]}
% \cvlistitem{Third place. XXIX Maraton Nacional de Programacion ACIS REDIS, Colombia. 2015}
\cvlistitem{Honorable mention. \textbf{ACM - ICPC World Finals}. Yekaterinburg, Russia. 2014 \footnotemark[1]}
\cvlistitem{Second place. Second UNAH Programming Cup. La Habana, Cuba. 2014}
\cvlistitem{Second place. ACM ICPC South America-North Regional Contest. Bogotá, Colombia. 2013 \footnotemark[1]}
...
\section{Languages}
\cvdoubleitem{Spanish}{Native}{English}{Good}
